            ...
            <div className="flex gap-4">
              <div className="flex flex-col">
                ...
                <select
                  name=""
                  id=""
                  className="text-xs px-2 w-fit py-px border  dark:border-white rounded outline-none"
                >
              ...
              <div className="flex flex-col">
                ...
                <select
                  name=""
                  id=""
                  className="text-xs w-fit border px-2 py-px dark:border-white rounded outline-none "
                >
